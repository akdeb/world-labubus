 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var G0=Ze,W0=Symbol.for("react.element"),X0=Symbol.for("react.fragment"),j0=Object.prototype.hasOwnProperty,$0=G0.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,Y0={key:!0,ref:!0,__self:!0,__source:!0};function ip(n,e,t){var i,r={},s=null,o=null;t!==void 0&&(s=""+t),e.key!==void 0&&(s=""+e.key),e.ref!==void 0&&(o=e.ref);for(i in e)j0.call(e,i)&&!Y0.hasOwnProperty(i)&&(r[i]=e[i]);if(n&&n.defaultProps)for(i in e=n.defaultProps,e)r[i]===void 0&&(r[i]=e[i]);return{$$typeof:W0,type:n,key:s,ref:o,props:r,_owner:$0.current}}Ea.Fragment=X0,Ea.jsx=ip,Ea.jsxs=ip,Wh.exports=Ea;var Ie=Wh.exports,rp={exports:{}},mn={},sp={exports:{}},op={};/**
 * @license React
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:rr,depthTest:!1,depthWrite:!1})}function Xv(){return new pr({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Nh(),fragmentShader:`
		...
		`,blending:rr,depthTest:!1,depthWrite:!1})}function jv(){return new pr({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Nh(),fragmentShader:`
...
#define LOW_PRECISION`),e}function lA(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===m_?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===gS?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===wi&&(e="SHADOWMAP_TYPE_VSM"),e}function uA(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Rs:case Cs:e="ENVMAP_TYPE_CUBE";break;case Bl:e="ENVMAP_TYPE_CUBE_UV";break}return e}function cA(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case Cs:e="ENVMAP_MODE_REFRACTION";break}return e}function fA(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case y_:e="ENVMAP_BLENDING_MULTIPLY";break;case US:e="ENVMAP_BLENDING_MIX";break;case FS:e="ENVMAP_BLENDING_ADD";break}return e}function dA(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:i,maxMip:t}}function hA(n,e,t,i){const r=n.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=lA(t),u=uA(t),c=cA(t),f=fA(t),d=dA(t),p=eA(t),g=tA(s),v=r.createProgram();let m,h,_=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(xa).join(`
`)),o=Fh(o),o=a0(o,t),o=l0(o,t),a=Fh(a),a=a0(a,t),a=l0(a,t),o=u0(o),a=u0(a),t.isRawShaderMaterial!==!0&&(_=`#version 300 es
